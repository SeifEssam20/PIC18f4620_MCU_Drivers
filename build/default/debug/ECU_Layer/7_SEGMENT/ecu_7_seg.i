...
# 17 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 17 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2

# 1 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../std_libs.h" 1
# 13 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../std_libs.h"
...
# 13 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../std_libs.h" 2
...
# 15 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../std_libs.h" 2
# 18 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 41 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 1 "ECU_Layer/7_SEGMENT/../../MCAL_Layer/GPIO/../device_cfg.h" 1
...
# 14 "ECU_Layer/7_SEGMENT/ecu_7_seg.h" 2
...
# 17 "ECU_Layer/7_SEGMENT/ecu_7_seg.c"
Std_ReturnType se7en_seg_init(const seg_t * seg_obj){
    ...
    if((((void*)0) == seg_obj)){
        ...
        retVal = gpio_pin_init(&(seg_obj->seg_pins[0]));
        retVal = gpio_pin_init(&(seg_obj->seg_pins[1]));
        retVal = gpio_pin_init(&(seg_obj->seg_pins[2]));
        retVal = gpio_pin_init(&(seg_obj->seg_pins[3]));
    }
    return retVal;
}
# 39 "ECU_Layer/7_SEGMENT/ecu_7_seg.c"
Std_ReturnType se7en_seg_wrt_num(const seg_t * seg_obj, uint8 num){
    Std_ReturnType retVal = (Std_ReturnType)0x01;;
    if((((void*)0) == seg_obj) || (num > 9)){
        retVal = (Std_ReturnType)0x00;;
    }
    else{
        retVal = gpio_pin_wrt_logic(&(seg_obj->seg_pins[0]),(num & 0x01));
        retVal = gpio_pin_wrt_logic(&(seg_obj->seg_pins[1]),((num >> 1) & 0x01));
        retVal = gpio_pin_wrt_logic(&(seg_obj->seg_pins[2]),((num >> 2) & 0x01));
        retVal = gpio_pin_wrt_logic(&(seg_obj->seg_pins[3]),((num >> 3) & 0x01));
    }
    return retVal;
}
