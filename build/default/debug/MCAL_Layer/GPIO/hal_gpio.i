...
# 13 "MCAL_Layer/GPIO/../std_libs.h" 2
...
# 15 "MCAL_Layer/GPIO/../std_libs.h" 2
# 18 "MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 41 "MCAL_Layer/GPIO/../mcal_std_types.h"
...
Std_ReturnType gpio_pin_direction_init(const pin_config_t * pin_config){
    ...
    {
        case(OUTPUT):
            (*tris_regs[pin_config->port] &= ~((uint8)0x01<<pin_config->pin));
            break;
        case(INPUT):
            (*tris_regs[pin_config->port] |= ((uint8)0x01<<pin_config->pin));
            break;
...
Std_ReturnType gpio_pin_wrt_logic(const pin_config_t *pin_config, logic_t logic){
    ...
    if((((void*)0) == pin_config) || (pin_config->pin > 8 - 1)){
        ...
        switch(logic){
            case(LOW) :
                (*lat_regs[pin_config->port] &= ~((uint8)0x01<<pin_config->pin));
                break;
            case(HIGH) :
                (*lat_regs[pin_config->port] |= ((uint8)0x01<<pin_config->pin));
                break;
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t *pin_config, direction_t *direction_status){
    ...
    if((((void*)0) == pin_config) || (((void*)0) == direction_status ) || (pin_config->pin > 8 - 1)){
        ...
        *direction_status = ((*lat_regs[pin_config->port] >> pin_config->pin) & (uint8)0x01);
        retVal = (Std_ReturnType)0x01;;
    }
...
Std_ReturnType gpio_pin_rd_logic(const pin_config_t *pin_config, logic_t *logic){
    ...
    if((((void*)0) == pin_config) || (((void*)0) == logic ) || (pin_config->pin > 8 - 1)){
        ...
        *logic = ((*port_regs[pin_config->port] >> pin_config->pin) & (uint8)0x01);
        retVal = (Std_ReturnType)0x01;;
    }
    return retVal;
}
...
# 178 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_direction_init(port_index_t port, uint8 direction){
    Std_ReturnType retVal = (Std_ReturnType)0x01;;
    if( port > 8 - 1){
        retVal = (Std_ReturnType)0x00;;
...
Std_ReturnType gpio_port_get_direction_status(port_index_t port, uint8 *direction_status){
    Std_ReturnType retVal = (Std_ReturnType)0x01;;
    if(( port > 8 - 1) || (((void*)0) == direction_status)){
        retVal = (Std_ReturnType)0x00;;
    }
    else{
